      ...
      <div className="relative ">
        ...
        <div className="bg-primary relative z-[10] ">
          ...
          <div className="pt-[80px] max-w-[353px] mx-auto text-center pb-[100px] md:pb-[50px] md:max-w-[640px]">
            <div className="relative ">
              <div className="absolute top-0 left-0 translate-y-[-50%] translate-x-[-59%]">
                <motion.img
              ...
              <div className="absolute top-0 left-0 translate-y-[-20%] translate-x-[190%]">
                <motion.img
              ...
              <div className="absolute bottom-0 left-0 translate-y-[20%] translate-x-[-75%]">
                <motion.img
              ...
              <div className="absolute bottom-0 left-0 translate-y-[40%] translate-x-[200%]">
                <motion.img
              ...
              <h1 className="text-[#FFFFFF] font-manrope font-bold text-[32px]  leading-[40px] pb-[16px] text-center text-nowrap  md:text-[48px] leading-[56px] ">
                <span className="block  ">Sell anything, anywhere </span>
              ...
              <p className="font-inter font-regular text-[#FFFFFF]/90 text-[14px] leading-[20px] pb-[24px] text-cent pb-[30px] md:text-[16px] md:px-4">
                Create your online store in minutes with tools made for your
                business. Share your link, collect orders, manage payments, and
                deliver.
              </p>

              <Button variant="white">Create your online store</Button>
              <p className="pt-[16px] text-center font-inter font-regular text-[#FFFFFF80] text-[14px] leading-[20px] pb-[80px]">
                No setup fees · No technical skills needed · Multi-language
                support.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-nowrap text-[#FFFFFF] font-inter font-regular text-[14px] leading-[20px] pt-[32px] md:text-[16px] md:leading-[24px]">
                <span className="block">Trusted by fast</span>
        ...
        <img
          ...
          alt="hero-star-image"
          className="w-full block  absolute    z-[2] translate-y-[-100px]  right-0 hidden md:block md:translate-y-[-200px]"
        />
      </div>
    </GeneralLayout>
  );
